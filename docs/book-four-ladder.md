...
fails if this file is out of date. Ids carry the book's `b4` prefix; a learner
never reads it.

[Book One](book-one-ladder.md) · [Book Two](book-two-ladder.md) · [Book Three](book-three-ladder.md) · **Book Four**
...
|---|---|---|
| うち | うち | one's own home, one's own household |
| 故障 | こしょう | breakdown, being out of order |
| 場面 | ばめん | scene (in a film or play) |
| 退屈 | たいくつ | boring, tedious |
| 少ない | すくない | few, not much |
...
- うちのクーラーが故障してしまった。 — Our air conditioner has broken down.
...
- 彼女にばっちりキスされちゃったよ。 — She kissed me full on the lips.

### 278. Ready in advance, left as it is
...
| Word | Reading | Meaning |
|---|---|---|
| 用意 | ようい | preparation, getting ready |
| あらかじめ | あらかじめ | beforehand, in advance |
| 自分 | じぶん | oneself |
| 任せる | まかせる | to leave (a job or decision) to someone, to entrust |
...
- あいつに仕事を任せておけば安心だ。 — If you leave the job to him, you can rest easy.
...
| Word | Reading | Meaning |
|---|---|---|
| 調べる | しらべる | to look up, to check, to investigate |
| 試す | ためす | to try out, to test |
| 者 | もの | person (of a stated kind) |
| 営業 | えいぎょう | business operations, sales |
| 宝石 | ほうせき | jewel, precious stone |
| もう | もう | already, yet |
| 一度 | いちど | once, one time |

- ヘッドライトをつけてみてください。 — Could you turn on your headlights?
- 営業の者と話をしてみました。 — I talked with our sales people.
- 調べてみるとその宝石はイミテーションだと分かった。 — On examination the jewel proved to be an imitation.
- もう一度それにトライしてみたら。 — Why don't you give it another try?
- 彼はそれを試してみたくてうずうずしていた。 — He was itching to have a go at it.

### 280. Away from here, on from now
...
| Word | Reading | Meaning |
|---|---|---|
| 追う | おう | to chase, to drive (animals) along |
| 牛 | うし | cow, cattle |
| どんどん | どんどん | steadily, more and more |
...
- 私達が生きていくためには衣食住が必要です。 — We need food, clothes and a home in order to go on living.
- 水着の上に羽織られるもの持っていったほうがいいね。 — It's a good idea to take along something to slip on over your bathing suit.

### 281. Towards you, up to now
...
| どんどん | どんどん | steadily, more and more |
| 数 | かず | number, count |
| 減る | へる | to decrease, to go down (in number) |
| 犬 | いぬ | dog |
| うち | うち | one's own home, one's own household |
| 買う | かう | to buy |
| 来る | くる | to come |
...
- お盆が近づいてきた。 — The Bon Festival is near at hand.
- ある種の動物はどんどん数が減ってきている。 — The numbers of certain animals are steadily falling.
- ついでに私のも買ってきてくれますか。 — Could you pick one up for me while you're out?
- 私の犬は、どこでも私の行くところへついてくる。 — My dog follows me wherever I go.
- うちの赤ん坊は口をきくようになってきました。 — Our baby is learning to speak.
...
| Word | Reading | Meaning |
|---|---|---|
| どうやら | どうやら | apparently, it seems |
| スープ | スープ | soup (Western) |
| スピード | スピード | speed |
| 危険 | きけん | dangerous, danger |
| 役に立つ | やくにたつ | to be useful, to come in handy |
| 大きい | おおきい | big, large |
...
| Word | Reading | Meaning |
|---|---|---|
| 外出 | がいしゅつ | going out (of the house) |
| 話し合う | はなしあう | to talk something over, to discuss |
| 船 | ふね | ship, boat |
| そのまま | そのまま | as it is, without changing anything |
| 二度と | にどと | never again |
...
- 船は全乗組員を乗せたまま海中へと沈んでいった。 — The ship went down under the sea with all her crew still aboard.
- １９００年に彼はイギリスを去り、そのまま二度と戻らなかった。 — In 1900, he left England, and he never returned.
...
| Word | Reading | Meaning |
|---|---|---|
| 割る | わる | to break, to crack, to split |
| 講義 | こうぎ | lecture |
| 手紙 | てがみ | letter |
...
- 学生達は身じろぎもせずに講義に聞き入っていた。 — The students listened to the lecture without stirring.
- 彼はその手紙を開封しないで送り返した。 — He sent the letter back unopened.
- お湯を全部使わないで。 — Don't use all the hot water.

### 285. Recognition checkpoint — closes the chapter

> A wide pass over everything this chapter taught — eight endings and forty-two words, which is more vocabulary than any chapter of the last book carried. Type the reading or the meaning rather than picking it out of a line-up. Four pairs are worth slowing down for, because they are the ones where getting it wrong costs you a sentence rather than a word. てしまう's two readings, finished against wish-it-hadn't, decided by the sentence and not by the form. ていく against てくる on the same verb, where the whole difference is which direction the speaker is standing in. ずに against the ないで that is a request, where the string is the same and the giveaway is whether another verb follows. And すぎる, too much, against 〜に過ぎない, merely — which this book has not taught yet and will not test, but which is close enough in shape to be worth knowing is coming. Anything you miss comes back sooner. It finishes when the remaining set empties; retry as often as you like, nothing is recorded.

---

## Chapter 2 — Meaning to, telling to

*Meaning to, telling to*

7 lessons · 50 words · 34 phrases
...
|---|---|---|
| 忍者 | にんじゃ | ninja |
| くどくど | くどくど | on and on, at tedious length |
| 娘 | むすめ | daughter; girl |
| 夫 | おっと | husband |
| 呼ぶ | よぶ | to call, to summon |
| お茶 | おちゃ | tea |

- ３時はお茶にしよう。 — Let's have tea at 3:00.
- 忍者ごっこをしよう。 — Let's make believe we're ninjas.
- その犬をスキッパーと呼ぼう。 — Let's call the dog Skipper.
- くどくど言わないようにしよう。 — Let's try not to go on about it.
...
| 動かす | うごかす | to move (something); to get (a machine) working |
| ドア | ドア | door |
| 無駄 | むだ | pointless, a waste |
| 開ける | あける | to open (something) |
| 終わる | おわる | to finish, to end |

- 彼女は宝石を盗もうとして捕まった。 — She was caught trying to steal jewelry.
- 彼はロボットを動かそうとした。 — He tried to make the robot run.
- ドアを開けようとしたら、ドアの握りがとれた。 — I tried to open the door, and the doorknob came off.
- 小型車のブームは終わろうとしている。 — The small car boom is about to end.
- 僕に金をせびろうとしても無駄だ。 — It's no use trying to get money out of me.
...
| Word | Reading | Meaning |
|---|---|---|
| 上手 | じょうず | good at, skilful |
| 間に合う | まにあう | to be in time for |
| 考える | かんがえる | to think about, to think over |
| 現実 | げんじつ | reality, the way things actually are |
...
- 後先をよく考えて物を言え。 — Think about what comes of it before you speak.
- 現実を回避するのはもうやめろ。 — Stop running away from reality.
...
| Word | Reading | Meaning |
|---|---|---|
| 触れる | ふれる | to touch; to touch on (a subject) |
| 他人 | たにん | other people, someone outside the family |
| 近寄る | ちかよる | to go near, to approach |
| 見せる | みせる | to show, to let someone see |
| お袋 | おふくろ | my mum |
| こと | こと | thing, matter |

- あくどい事をするな。 — Don't do wicked things.
- お袋の前ではそのことに触れるな。 — Don't bring it up in front of my mum.
- 他人のいうことを気にかけるな。 — Don't worry about what others say.
- 喜怒哀楽を見せるな。 — Don't let your feelings show.
- 噛みつくといけないのでそのブルドッグに近寄るな。 — Don't go near the bulldog, in case he bites you.

### 291. Do it, from above
...
| Word | Reading | Meaning |
|---|---|---|
| 迷う | まよう | to lose one's way; to be unable to decide |
| 安全 | あんぜん | safe, safety |
| 隠す | かくす | to hide (something), to conceal |
| 見つける | みつける | to find, to spot |
| 何か | なにか | something, anything |
| 道 | みち | road, street, way |
| 地図 | ちず | map |
| 咳 | せき | cough |

- 帽子を弄り回すのはやめなさい。 — Stop fiddling with your hat.
...
- 家でごろごろするのをやめて、何かすることを見つけなさい。 — Stop being lazy and find something to do.
- 道に迷うといけないから、地図をもって行きなさい。 — Take a map with you in case you get lost.

### 292. What someone else wants
...
|---|---|---|
| 新車 | しんしゃ | a new car |
| 飼う | かう | to keep (an animal) |
| 男性 | だんせい | man, male |
| 休暇 | きゅうか | leave, time off |
| 起こる | おこる | to happen, to occur |
| 誰も | だれも | everyone; (with a negative) nobody |
| 売る | うる | to sell |
| 車 | くるま | car |

- トムはしきりに新車を買いたがっている。 — Tom is eager to buy a new car.
- ディーラーは車を売りたがっている。 — The dealer wants to sell a car.
- ナンシーは犬を飼いたがっていますか。 — Does Nancy want to have a dog?
- ほんの一握りの男性しか育児休暇を取りたがらない。 — Only a handful of men want to take childcare leave.
- 何事が起こったのか誰もが知りたがっていた。 — Everybody was anxious to know what had happened.

### 293. Recognition checkpoint — closes the chapter

> A wide pass over the seven forms this chapter taught and the words that came with them. Four pairs are worth slowing down for, because in each one the same message arrives at two different registers and the only difference is the ending. しよう against しましょう — the same proposal, one to a friend and one to a stranger. やめろ against やめなさい against やめてください — stop it, told, instructed and asked. するな against しないでください — the same prohibition, one blunt and one polite. 買いたい against 買いたがっている — my wish and somebody else's. Two more places give trouble the first time and are worth expecting. A sentence ending in だろう is not a volitional, whatever it looks like; and a sentence ending in な is a prohibition only when the form in front of it is the dictionary form. Type the reading or the meaning rather than picking it out of a line-up. Anything you miss comes back sooner. It finishes when the remaining set empties; retry as often as you like, and nothing is recorded.

---

## Chapter 3 — Why you're saying it

*Why you're saying it*

6 lessons · 34 words · 33 phrases

### 294. Because that's the reason
...
| 手に入れる | てにいれる | to obtain, to get hold of |
| 仕方 | しかた | way of doing something, method |
| 流行 | りゅうこう | fashion, trend, what is in vogue |
| 最新 | さいしん | newest, the latest |

- 私はギタリストになりたいんです。 — I'd like to be a guitarist.
- リレー用のバトンが１本足りないんです。 — We're one baton short for the relay.
- どうやってそのお金を手に入れたんですか。 — How did you get hold of that money?
- この自動販売機、動かないんですが。 — This vending machine isn't working.
- フランスへの送金の仕方を教えて欲しいんですが。 — I'd like you to tell me how to send money to France.
- おしぼりが欲しいのです。 — I'd like a hot towel.
...
| 本物 | ほんもの | the genuine article, the real thing |
| 以内 | いない | within, inside of |
| 復活 | ふっかつ | revival, comeback |
| 政府 | せいふ | government, administration |
| 機関 | きかん | agency, institution, organisation |

- １時間以内にそこに着くでしょう。 — We'll probably get there within an hour.
- これは本物のダイヤでしょう。 — This is probably a real diamond.
- ミニスカートはすぐに復活するだろう。 — Miniskirts will probably come back soon.
- どんなに骨を折ってやっても、結果は同じでしょう。 — No matter how hard you try, the result will probably be the same.
- 彼女は政府機関に勤めているのでしょう？ — She's with a government bureau, isn't she?
- これは悪い話ではないでしょう？ — This isn't a bad deal, is it?
...
| 叔父 | おじ | uncle |
| 新聞 | しんぶん | newspaper |
| 町 | まち | town, neighbourhood |
| 翻訳 | ほんやく | translation (of writing) |

- ビルは結局医大に行くそうだ。 — I hear Bill will go to medical school after all.
- 叔父の死因は癌だったそうです。 — I hear my uncle died of cancer.
- マイクは病気で寝こんでいるそうだ。 — They say that Mike is sick in bed.
- あの翻訳は原文に忠実だそうだ。 — That translation is said to be true to the original.
- 新聞によれば、その町に大火があったそうだ。 — According to the papers, there was a big fire in the town.
...
| 簡単 | かんたん | simple, easy |
| 不安 | ふあん | uneasy, anxious; anxiety |
| 実は | じつは | actually, to tell the truth |
| まもなく | まもなく | soon, before long |
...
- 彼はあなたとうまくやっていけそうな人だった。 — He looked like the sort of man you could get along with.
...
| 極端 | きょくたん | extreme |
| 君 | きみ | you (familiar) |
| 水増し | みずまし | watering down, padding (of a figure) |
| そんなに | そんなに | that much, like that |
| パブ | パブ | pub |
| ウスターソース | ウスターソース | Worcester sauce |
...
| そいつ | そいつ | that one, that thing (blunt) |
| レトリック | レトリック | rhetoric |
| いわゆる | いわゆる | so-called, what people call |
...
- そいつは衰退のレトリックというものだ。 — That's the rhetoric of decline.
- これがいわゆる「天ぷら」というものです。 — This is what we call "tempura".

### 300. Recognition checkpoint — closes the chapter

> A wide pass over everything this chapter has taught. Type the reading or the meaning rather than picking it out of a line-up. Three of the pairs here are worth slowing down for, and they are the ones the chapter was built around. 降るそうだ against 降りそうだ: one clause, one stem, and the difference between what you were told and what you can see. でしょう against the stance chapter's かもしれない and に違いない: the same line from not sure to certain, with the middle of it now filled in. いいんじゃない？ against 食べるんじゃない: one string, a suggestion and a prohibition, sorted by what stands in front of it and by a tone of voice that writing does not record. Attachment is the other thing being checked, because it is where these differ most on the page — the な that んです needs after a noun, the bare noun that でしょう takes with no copula at all, and the だ that stays in place in 忠実だそうだ and disappears in 簡単そうだ. Anything you miss comes back sooner. It finishes when the remaining set empties; retry as often as you like, nothing is recorded.

---

## Chapter 4 — How people actually talk

*How people actually talk*

8 lessons · 57 words · 40 phrases
...
| 遊び | あそび | pleasure; amusement; play |
| 別に | べつに | (not) particularly; (not) especially |
| たまに | たまに | occasionally; once in a while |
| 死語 | しご | a word nobody says anymore; a dead language |
| 手先 | てさき | someone's stooge; a pawn |
| 仕事 | しごと | work, job |
| 悪い | わるい | bad |

- 今度の旅行は仕事じゃなくて遊びです。 — Our next trip is for pleasure, not for work.
- 百円じゃなくて、王冠でした。 — It wasn't a 100 yen coin, it was a bottle cap.
- それって死語じゃないの。 — That's a dead word now, isn't it?
- あいつの手先じゃない。 — I'm not his stooge.
...
| Word | Reading | Meaning |
|---|---|---|
| 得 | とく | a good deal; profitable |
| 自滅 | じめつ | self-destruction; ruining oneself |
| ウエスト | ウエスト | waist; waistline |
| じれったい | じれったい | exasperating; frustrating to watch |
| ほう | ほう | side, the one of two |
| 天気 | てんき | weather |

- 買い替えた方がお得ですよ。 — You'd be better off buying a new one.
- いいお天気ですね。 — It's a beautiful day, isn't it?
- ちょっとウエストがきついね。 — The waist is a little tight.
- 君のやることはじれったいね。 — The way you do things is exasperating.
- 今の日本は自滅へのみちを突き進んでいますよね。 — Present-day Japan is going down the route to self-destruction, isn't it?

### 303. To yourself, out loud
...
| Word | Reading | Meaning |
|---|---|---|
| 始める | はじめる | to start; to begin (something) |
| 気に入る | きにいる | to like; to take a liking to |
| 双子 | ふたご | twins |
| ほとんど | ほとんど | almost; hardly (with a negative) |
| 付き | つき | with; including (attached to a noun) |
| 僕 | ぼく | I; me (used by men and boys) |
| 電話 | でんわ | telephone |

- 君はウオーミングアップを始めたな。 — You've started warming up.
- 僕はエンディングが気に入らなかったな。 — Oh, I didn't like the ending.
- ああ、バスタブ付きがいいな。 — Oh, one with a bathtub would be nice.
- あの双子は瓜二つだな。 — Those twins look like two peas in a pod.
- ダイヤル式の電話って、ほとんど見なくなったな。 — You don't see many dial phones around anymore.
...
| Word | Reading | Meaning |
|---|---|---|
| 出張 | しゅっちょう | a business trip |
| キャンセル | キャンセル | cancellation; to cancel |
| そろそろ | そろそろ | soon; about time to |
| この前 | このまえ | the other day; last time |
| サンドイッチ | サンドイッチ | a sandwich |
| ほう | ほう | side, the one of two |
| おにぎり | おにぎり | rice ball |
| 覚える | おぼえる | to memorise, to remember |

- ロス出張をキャンセルしようかな。 — Maybe I'll cancel my L.A. business trip.
- そろそろプログラミングを覚えようかな。 — Maybe it's about time I started learning to program.
- これは誰の車かしら。 — I wonder whose car this is.
- サンドイッチとおにぎりじゃ、どっちが重いかしら。 — I wonder which is heavier, a sandwich or a rice ball.
- 車酔いするほうだっけ？ — Don't you tend to get carsick?
- この前、僕が君にあったのはいつだっけ。 — Do you remember when I saw you last?

### 305. Things like that
...
| Word | Reading | Meaning |
|---|---|---|
| 夢 | ゆめ | a dream (asleep or hoped for) |
| 失敗 | しっぱい | failure; a mistake |
| 決して | けっして | never; not at all (with a negative) |
| パソコン | パソコン | a personal computer |
| 愚か | おろか | foolish; silly |
| 変 | へん | strange; odd |
| 何 | なに | what |

- １等になるなんて夢にも思わなかった。 — Never did I dream of winning first prize.
- また同じ失敗をするなんて、我ながら愚かだと思う。 — It is silly of me to have made the same mistake twice.
- 彼はなんて大食らいなんだろう。 — What a big eater he is!
- この仕事は決してやさしくなんかないんだよ。 — This work is anything but easy.
- 私のパソコンなんかへんでネットに乗れませんでした。 — Something was wrong with my computer and I couldn't get online.
...
|---|---|---|
| 鍋 | なべ | a pot; a pan |
| 包丁 | ほうちょう | a kitchen knife |
| 親 | おや | a parent; parents |
| 面倒 | めんどう | a bother; looking after someone (in 面倒を見る) |
| 持参 | じさん | bringing something with you |
| 台所 | だいどころ | kitchen |
| 軽い | かるい | light (in weight) |

- 包丁とか鍋とか、台所用品を持参すること。 — Bring kitchen utensils such as knives and pots.
- 明日からコーンフレークとか、軽い物にしようか？ — Shall we go with cornflakes or something light from tomorrow?
- マルコーニさんとかいう人がご面会です。 — A Mr. Marconi wants to see you.
- 私も親の面倒とか見られないですね。 — I can't look after my parents and such either.

### 307. Rough and soft endings
...
| Word | Reading | Meaning |
|---|---|---|
| 今回 | こんかい | this time; on this occasion |
| 信用 | しんよう | trust; confidence in someone |
| あんな | あんな | that sort of; like that |
| ノート | ノート | a notebook |
| 劇場 | げきじょう | a theatre |
| 貸す | かす | to lend |
| 電車 | でんしゃ | train |
...
- ほら、あなたの乗る電車が来たわ。 — Look, here comes your train.

### 308. Just do it, would you
...
| Word | Reading | Meaning |
|---|---|---|
| 捕まえる | つかまえる | to catch; to grab hold of |
| テレビ | テレビ | a television; TV |
| 謝る | あやまる | to apologise |
| 変える | かえる | to change something |
| ティッシュ | ティッシュ | a tissue |
| 持ってくる | もってくる | to bring |
| つける | つける | to turn on, to switch on |

- そいつをつかまえて！ — Get him!
- テレビをつけて。 — Please turn on the television.
- ティッシュを持ってきて。 — Bring me the tissues.
- 謝ったんだから、さっきのはチャラにしてよ。 — I've apologised, so lay off, OK?
- そんなにコロコロ、言う事を変えないでくれよ。 — Don't change what you say so often.
...
| しかし | しかし | however (in writing); but |
