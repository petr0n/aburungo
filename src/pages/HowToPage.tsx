      ...
      <div className="w-full">
        ...
        <div className="flex flex-col gap-6">
          <section className="rounded-2xl border border-border bg-surface p-6">
            <h3 className="mb-4 text-heading-sm font-semibold text-fg">Studying</h3>
          ...
          <section className="rounded-2xl border border-border bg-surface p-6">
            <h3 className="mb-4 text-heading-sm font-semibold text-fg">Content</h3>
          ...
          <section className="rounded-2xl border border-border bg-surface p-6">
            <h3 className="mb-4 text-heading-sm font-semibold text-fg">Tips</h3>
            <ul className="flex flex-col gap-2">
              {[
